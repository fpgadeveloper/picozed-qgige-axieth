...
#   /____   \____
#  / \===\   \==/
# /___\===\___\/  AVNET PicoZed + PZCC-FMC 7020 Board Definition
#      \======/         www.PicoZed.org
#       \====/    
# ----------------------------------------------------------------------------
# 
...
#    19 Feb 2015 -- Switched MIO 47 from SOM Ethernet Reset to Carrier LED
#                -- Disabled ENET0_RESET. Enabling requires resistor change
#                   on the PZCC-FMC
#                -- Labeled MIO 50 as Carrier Ethernet Reset
#                -- Enabled SD1 CD for eMMC. Tied to Constant 0 to be Always
#                   detected.
#
