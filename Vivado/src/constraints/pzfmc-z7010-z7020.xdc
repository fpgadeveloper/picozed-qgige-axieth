...
set_property PACKAGE_PIN U13 [get_ports {rgmii_port_2_rd[1]}]
set_property PACKAGE_PIN U12 [get_ports {rgmii_port_2_td[0]}]
...
set_property PACKAGE_PIN N15 [get_ports mdio_io_port_3_io]
