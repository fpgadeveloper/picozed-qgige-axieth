...
set_property PACKAGE_PIN G1 [get_ports mdio_io_port_0_io]
set_property PACKAGE_PIN D2 [get_ports {rgmii_port_1_rd[2]}]
set_property PACKAGE_PIN G8 [get_ports {ref_clk_fsel[0]}]
set_property PACKAGE_PIN G7 [get_ports mdio_io_port_1_io]
...
set_property PACKAGE_PIN M1 [get_ports mdio_io_port_2_io]
...
set_property PACKAGE_PIN J8 [get_ports mdio_io_port_3_io]
